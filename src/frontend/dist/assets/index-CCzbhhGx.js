...
function ToastItem({ toast, onRemove }) {
  ...
  const borderColor = toast.type === "success" ? "rgba(52,211,153,0.3)" : toast.type === "error" ? "rgba(248,113,113,0.3)" : "rgba(108,99,255,0.3)";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      style: {
...
function ToastContainer({ toasts, onRemove }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: toasts.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(ToastItem, { toast: t, onRemove }, t.id))
    }
  );
}
const TEAM = [
...
function AboutTab() {
  ...
  reactExports.useEffect(() => {
    var _a2;
    const reveals = (_a2 = sectionRef.current) == null ? void 0 : _a2.querySelectorAll(".reveal");
    if (!reveals) return;
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-tag", children: "About" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title", children: "Meet the Team" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-sub", children: "Built with passion by students, for students. Powered by cutting-edge AI research." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: TEAM.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "reveal",
                style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            className: "reveal",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-tag", style: { marginBottom: "24px" }, children: "Tech Stack" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                  ...
                  children: TECH.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      style: {
                        display: "flex",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h3",
                {
                  ...
                  children: "This is a college project demo"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "ResumeAI demonstrates AI-powered resume analysis with a real-looking frontend. The analysis shown is simulated for demo purposes. Built as a semester project in Computer Science."
                }
              )
            ]
          }
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: { textAlign: "center", marginBottom: "60px" },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-tag", children: "Benefits" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-title", children: [
                "Built for Students",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                "& Job Seekers"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-sub", children: "Whether you're a fresh graduate or switching careers, ResumeAI levels the playing field." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: BENEFITS.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "reveal",
                style: {
...
function FeatureCard({ f, index: index2 }) {
  const [hovered, setHovered] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "feature-card glass reveal",
      "data-ocid": `feature.item.${index2 + 1}`,
      ...
      style: {
        ...
        boxShadow: hovered ? `0 0 0 1px ${f.accentHex}33, 0 8px 32px ${f.glowColor}` : "none",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: { textAlign: "center", marginBottom: "60px" },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-tag", children: "Features" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-title", children: [
                "Everything You Need to",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                "Stand Out"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-sub", children: "Powered by advanced NLP and machine learning models trained on millions of job listings." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: FEATURES.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureCard, { f, index: i }, f.title))
          }
        )
      ]
    }
...
const FUTURE_ITEMS = [
  {
    ...
    description: "Integrate large language models (LLMs) like GPT or Gemini to genuinely parse and understand resume content — extracting skills, experience, and achievements with true natural language understanding.",
    tag: "Core AI"
  },
  {
    icon: "🎯",
    title: "Job Description Matching",
    description: "Allow users to paste a job description and use AI to compute a semantic similarity score, identifying gaps in skills and suggesting targeted improvements for that specific role.",
    tag: "Personalization"
  },
  {
    icon: "✍️",
    title: "AI-Powered Rewriting",
    description: "Use generative AI to automatically rewrite weak bullet points, suggest stronger action verbs, and produce quantified achievement statements tailored to the candidate's industry.",
    tag: "Content AI"
  },
  {
    icon: "📊",
    title: "Real ATS Simulation",
    description: "Train a machine learning model on actual ATS systems to accurately predict how a resume would be scored and filtered, replacing the current simulated scoring with genuine predictions.",
    tag: "ML Model"
  },
  {
    icon: "🌐",
    title: "Industry-Specific AI Models",
    description: "Fine-tune AI models per industry (tech, finance, healthcare, etc.) so feedback and keyword suggestions are precisely aligned with what recruiters in each field actually look for.",
    tag: "Domain AI"
  },
  {
    icon: "📈",
    title: "Career Trajectory Analysis",
    description: "Use AI to analyze career progression patterns from resumes and suggest next logical roles, skill upgrades, and certifications based on the candidate's experience timeline.",
    tag: "Career AI"
  },
  {
    icon: "🔍",
    title: "Real-Time Job Market Insights",
    description: "Connect AI analysis with live job market data to surface trending skills, in-demand keywords, and salary benchmarks relevant to the candidate's target role and location.",
    tag: "Data & AI"
  },
  {
    icon: "🗣️",
    title: "AI Mock Interview Prep",
    description: "Extend beyond the resume: use AI to generate personalised interview questions based on resume content and provide coaching on likely areas where the candidate may be challenged.",
    tag: "Coaching AI"
  },
  {
    icon: "🌍",
    title: "Multilingual Resume Support",
    description: "Leverage AI translation and localisation models to support resumes in multiple languages and adapt feedback to region-specific hiring norms across different countries.",
    tag: "NLP"
  },
  {
    icon: "🔒",
    title: "Privacy-First On-Device AI",
    description: "Run lightweight AI models directly in the browser using WebAssembly or WebGPU so resume content is never sent to any server, maintaining full privacy while delivering real AI insights.",
    tag: "Edge AI"
  }
];
const TAG_COLORS = {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-tag", children: "Future Scope" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title", children: "The Road Ahead with AI" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "section-sub",
                  style: { maxWidth: "620px", margin: "0 auto" },
                  children: "This is a demo project today — but here's how real AI can transform resume analysis into a truly intelligent career companion."
                }
              )
            ]
          }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "2.5rem", marginBottom: "12px" }, children: "🚀" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h3",
                {
                  style: {
                  ...
                  children: "From Simulated Demo to Real AI Intelligence"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "The features below outline a realistic path for evolving ResumeAI into a production-grade platform powered by genuine machine learning and large language models."
                }
              )
            ]
          }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: FUTURE_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                onMouseEnter: (e) => {
                  ...
                  el.style.borderColor = "rgba(108,99,255,0.3)";
                  el.style.boxShadow = "0 16px 50px rgba(0,0,0,0.25), 0 0 0 1px rgba(108,99,255,0.1)";
                },
                onMouseLeave: (e) => {
                  const el = e.currentTarget;
                  el.style.transform = "translateY(0)";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "2rem", marginBottom: "12px" }, children: "💡" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h3",
                {
                  style: {
                  ...
                  children: "Built as a College Project — Designed for the Future"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "ResumeAI started as a semester project to explore how AI could revolutionise career tools. The scope above represents the natural next steps — turning this proof-of-concept into a real, AI-driven platform that genuinely helps job seekers land their dream roles."
                }
              )
            ]
          }
...
function useAudioEngine() {
  ...
  const playHover = reactExports.useCallback(() => {
    try {
      const ctx = getCtx();
      const o = ctx.createOscillator();
      const g = ctx.createGain();
      ...
      g.gain.exponentialRampToValueAtTime(1e-3, ctx.currentTime + 0.06);
      o.start(ctx.currentTime);
  ...
  const playResults = reactExports.useCallback(() => {
    try {
      const ctx = getCtx();
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "Upload your resume and get instant AI-driven feedback on ATS compatibility, keyword optimization, and actionable improvements to land your dream job."
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            "data-ocid": "home.card",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(StatCounter, { target: 98, label: "ATS Accuracy", suffix: "%" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(StatCounter, { target: 4, label: "Sec Analysis Time", suffix: "s" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(StatCounter, { target: 92, label: "Success Rate", suffix: "%" })
            ]
          }
        )
      ]
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: { textAlign: "center", marginBottom: "60px" },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-tag", children: "Process" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title", children: "How It Works" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-sub", children: "From upload to insights in four intelligent steps." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative" }, children: [
          ...
          STEPS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "reveal",
              style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { position: "relative", zIndex: 1, color }, children: value })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function getFutureScopeItems(data) {
  const items = [];
  if (data.keywords < 80) {
    items.push({
      icon: "🤖",
      title: "AI-Powered Keyword Injection",
      description: "A future AI model could scan live job postings and auto-suggest the most relevant missing keywords tailored to your target role — boosting your ATS pass rate significantly.",
  ...
  if (data.impact < 80) {
    items.push({
      ...
      description: 'With a GPT-style model, weak or passive bullet points could be automatically rewritten into strong, quantified achievement statements — transforming "Worked on features" into "Delivered 4 features reducing load time by 40%".',
      tag: "Generative AI",
      tagColor: "#f472b6"
    });
  }
  if (data.ats < 90) {
    items.push({
      ...
      description: "An AI agent could accept a pasted job description and produce a real-time gap analysis — showing exactly which skills, phrases, and experience to add for that specific role.",
      tag: "LLM · Role Fit",
      tagColor: "#22d3ee"
    });
  }
  items.push({
    ...
    description: "A language model trained on thousands of winning resumes could auto-draft a personalized professional summary section based on your experience and target industry — one of the highest-impact additions to any resume.",
    tag: "Generative AI",
    tagColor: "#34d399"
  });
  items.push({
    ...
    description: "AI could analyse recruiter attention patterns and recommend an optimal section order for your specific career stage — for example, placing Projects before Experience for fresh graduates.",
  ...
  if (data.readability < 85) {
    items.push({
      ...
      description: "An NLP model could detect overly complex sentences, passive voice, and inconsistent tense — and suggest cleaner rewrites that are easier for both humans and automated scanners to parse.",
      tag: "NLP · Readability",
      tagColor: "#a78bfa"
    });
  }
  items.push({
    ...
    description: "AI could maintain a master resume and automatically generate tailored versions for different roles — so you send a slightly different, optimised resume to each company without manual editing.",
    tag: "Automation",
    tagColor: "#6c63ff"
  });
...
`;
  ...
  const scores = data ? [
    {
      label: "Overall Score",
      value: data.overall,
      color: data.overall >= 80 ? "#34d399" : data.overall >= 60 ? "#fb923c" : "#f87171"
    },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      style: { padding: "80px 24px", maxWidth: "1200px", margin: "0 auto" },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", marginBottom: "60px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-tag", children: "Results" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title", children: "Your Analysis Report" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-sub", children: "Comprehensive AI-powered insights about your resume." })
        ] }),
        !data ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "var(--text2)", marginBottom: "24px" }, children: "Upload your resume on the Upload tab and click “Analyze Now” to generate your report." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: scores.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ScoreRing,
                    {
                      value: s.value,
                      label: s.label,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    data.suggestions.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        style: {
                          display: "flex",
                          ...
                          gap: "12px",
                          padding: "12px 0",
                          borderBottom: i < data.suggestions.length - 1 ? "1px solid var(--border)" : "none",
                          fontSize: "0.87rem",
                          color: "var(--text2)",
                          lineHeight: 1.6
                        },
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "16px" }, children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: "8px" }, children: data.foundKeywords.map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          style: {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: "8px" }, children: data.missingKeywords.map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          style: {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative", zIndex: 1 }, children: [
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "h3",
                              {
                                ...
                                children: "🚀 Future Scope — AI-Powered Improvements"
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "span",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          ...
                          children: "Based on your analysis scores, here are the AI-driven enhancements that could take your resume to the next level."
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: futureScopeItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              style: {
                                background: "var(--surface)",
...
function UploadTab({ onAnalyze, onToast }) {
  ...
  const [spinnerLabel, setSpinnerLabel] = reactExports.useState("Uploading your resume...");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", marginBottom: "60px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-tag", children: "Upload" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title", children: "Drop Your Resume Here" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-sub", children: "We support PDF, DOCX, and TXT files. Your data is processed securely and never stored." })
        ] }),
        (uploadState === "idle" || uploadState === "done") && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              boxShadow: dragOver ? "0 0 40px var(--glow), inset 0 0 40px rgba(108,99,255,0.03)" : "none",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "or click to browse files from your computer"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: ["PDF", "DOCX", "TXT", "Max 10MB"].map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      style: {
                        background: "var(--surface2)",
        ...
        uploadState === "uploading" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "var(--text2)", fontSize: "0.9rem" }, children: spinnerLabel })
            ]
          }
        ),
        uploadState === "progressing" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: "16px" }, "data-ocid": "upload.loading_state", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
        ...
        uploadState === "done" && uploadedFile && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1 }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { fontSize: "0.83rem", color: "var(--text2)" }, children: [
                  uploadedFile.name,
                  " · ",
...
function App() {
  ...
  const [analysing, setAnalysing] = reactExports.useState(false);
  ...
  const switchTab = reactExports.useCallback(
    (tab) => {
      playClick();
      setActiveTab(tab);
      setMobileOpen(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { minHeight: "100vh" }, children: [
                ...
                "div",
                {
                  ...
                  children: TABS.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      onMouseEnter: playHover,
                      style: {
                        background: activeTab === tab.id ? "rgba(108,99,255,0.12)" : "none",
                        border: "none",
                        cursor: "pointer",
                        fontFamily: "var(--font-body)",
                        fontSize: "0.82rem",
    ...
    mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: {
          ...
          right: 0,
          zIndex: 99,
          background: isDark ? "rgba(8,11,20,0.97)" : "rgba(244,243,255,0.97)",
          backdropFilter: "blur(20px)",
          borderBottom: "1px solid var(--border)",
          padding: "16px",
          display: "flex",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "main",
      {
        ...
        children: [
          activeTab === "home" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { animation: "fadeSlideIn 0.45s ease" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(HomeTab, { onSwitchTab: (t) => switchTab(t) }) }),
          activeTab === "upload" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { animation: "fadeSlideIn 0.45s ease" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(UploadTab, { onAnalyze: startAnalysis, onToast: showToast }) }),
          activeTab === "features" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { animation: "fadeSlideIn 0.45s ease" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FeaturesTab, {}) }),
          activeTab === "how" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { animation: "fadeSlideIn 0.45s ease" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(HowItWorksTab, {}) }),
          activeTab === "benefits" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { animation: "fadeSlideIn 0.45s ease" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(BenefitsTab, {}) }),
          activeTab === "results" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { animation: "fadeSlideIn 0.45s ease" }, children: analysing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "section",
            {
              style: {
                padding: "80px 24px",
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "var(--text2)", fontSize: "0.9rem" }, children: "Running AI analysis..." })
                  ]
                }
              )
            }
          ...
          activeTab === "future" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { animation: "fadeSlideIn 0.45s ease" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FutureScopeTab, {}) }),
          activeTab === "about" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { animation: "fadeSlideIn 0.45s ease" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AboutTab, {}) })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
